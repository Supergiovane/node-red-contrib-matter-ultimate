...
// This engine wraps matter-ultimate-config's matterManager (the controller), NOT the
// generic Matter controller paths.
class MatterLightEngine extends LightEngine {
  constructor (opts = {}) {
    super(opts)
    this.manager = opts.manager // matter-ultimate-config's matterManager (writeMatterQueueAdd)
