...
describe('Flow migration backup', function () {
  ...
  it('exposes the same API in a plain browser script', function () {
    ...
    expect(context.MatterStandaloneKNXUltimateFlowMigrationBackup.download).to.be.a('function')
    context.MatterStandaloneKNXUltimateFlowMigrationBackup.download(backup.RED, { kind: 'hue' })
