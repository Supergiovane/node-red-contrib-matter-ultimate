...
describe('Matter controller editor persistence and terminology', () => {
  const editorPath = path.join(__dirname, '..', 'nodes', 'matterUltimateController.html')
  ...
  it('uses Matter terminology in the rendered English help', () => {
    const help = editor.split('<script type="text/markdown" data-help-name="matterUltimateController">')[1] || ''
  ...
  it('uses Matter terminology in every localized editor string', () => {
    for (const locale of ['en', 'it', 'de', 'fr', 'es', 'zh-CN']) {
      const localePath = path.join(__dirname, '..', 'nodes', 'locales', locale, 'matterUltimateController.json')
      const values = []
  ...
  it('does not duplicate Node-RED help titles in localized Matter help', () => {
    for (const locale of ['en', 'it', 'de', 'fr', 'es', 'zh-CN']) {
      for (const nodeName of ['matterUltimateController', 'matterUltimateBridge']) {
